...
firepad.AlternateAdapter = (function (global) {
  ...
  function AlternateAdapter (ref, userId, userColor) {
    this.ref_ = ref;
    this.ready_ = false;
    this.firebaseCallbacks_ = [];
    this.zombie_ = false;
    this.request = new XMLHttpRequest();
    // FIXME: make this request async
  ...
  utils.makeEventEmitter(AlternateAdapter, ['ready', 'cursor', 'operation', 'ack', 'retry']);

  AlternateAdapter.prototype.dispose = function() {
    var self = this;
  ...
  AlternateAdapter.prototype.isHistoryEmpty = function() {
   ...
   */
  AlternateAdapter.prototype.sendOperation = function (operation, callback) {
    var self = this;
  ...
  AlternateAdapter.prototype.sendCursor = function (obj) {
    if(obj) {
  ...
  AlternateAdapter.prototype.setColor = function(color) {
    // FIXME: re-implement as required
    // this.userRef_.child('color').set(color);
    this.color_ = color;
  };

  AlternateAdapter.prototype.getDocument = function() {
    return this.document_;
  };

  AlternateAdapter.prototype.registerCallbacks = function(callbacks) {
    for (var eventType in callbacks) {
      this.on(eventType, callbacks[eventType]);
    }
  };

  AlternateAdapter.prototype.initializeUserData_ = function() {
    // FIXME: re-implement as required
  ...
  AlternateAdapter.prototype.monitorHistory_ = function() {
    var self = this;
    ...
    // FIXME: Re-implement checkpoints
  ...
  AlternateAdapter.prototype.monitorHistoryStartingAt_ = function(revision) {
    ...
    setTimeout(function() {
      // FIXME: make request async
      self.request.open(
        'GET', self.ref_.server + '/document/' + self.ref_.document +
        '/history', false);
  ...
  AlternateAdapter.prototype.handleInitialRevisions_ = function() {
  ...
  AlternateAdapter.prototype.handlePendingReceivedRevisions_ = function() {
  ...
  AlternateAdapter.prototype.parseRevision_ = function(data) {
  ...
  AlternateAdapter.prototype.saveCheckpoint_ = function() {
...
firepad.Firepad = (function(global) {
  ...
  var FirebaseAdapter = firepad.AlternateAdapter;
